...
To test that your installation works, you can run any script in our `test` directory. This will run the GUI on some synthetic data. E.g. from the `spikeinterface-gui` folder, you could run
