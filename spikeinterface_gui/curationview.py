...
class CurationView(ViewBase):
    ...
    def _qt_refresh(self):
        from .myqt import QT
        # Merged
        merged_units = self.controller.curation_data["merges"]
    ...
    def _qt_on_item_selection_changed_merge(self):
        ...
        visible_unit_ids = self.controller.curation_data["merges"][ind]
        visible_unit_ids = [dtype.type(unit_id) for unit_id in visible_unit_ids['unit_ids']]
    ...
    def _panel_refresh(self):
        ...
        ## deleted        
        removed_units = self.controller.curation_data["removed"]
        removed_units = [str(unit_id) for unit_id in removed_units['unit_ids']]
